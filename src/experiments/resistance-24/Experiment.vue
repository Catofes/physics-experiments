...
.game-stage { padding: 28px; color: #e5f3ed; }
...
.stage-instruction { margin: 24px 0 16px; }
...
@media (max-width: 600px) { .game-stage { padding: 16px; } .circuit-grid { gap: 10px; } .circuit-card { padding: 10px; } .circuit-card.combined { grid-column: 1 / -1; } .target { font-size: 54px; } .game-actions { gap: 8px; } .game-actions .lab-button { flex: 1 1 40%; } }
</style>
